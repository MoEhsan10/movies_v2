                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Align(
                            ...
                            child: Text('Forget Password ?',style: AppStyles.suggestion,)),
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('Don’t Have Account ? ', style: AppStyles.suggestion.copyWith(color: ColorsManager.white),),
                          GestureDetector(
                              onTap: () {
                                Navigator.pushReplacementNamed(context, Routes.register);
                              },
                              child: Text('Create One',style: AppStyles.suggestion,)),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            width: 91.8.w,
                            height: 1.h,
                            color: ColorsManager.yellow, // Simple color property for solid color
                          ),
                          SizedBox(width: 10.w),
                      ...
                      CustomElevatedButton(
                        ...
                        onTap: () {},
                        textStyle: AppStyles.elevatedButton,
                        prefixIcon: const ImageIcon(AssetImage(ImageAssets.google)),
                      ),
